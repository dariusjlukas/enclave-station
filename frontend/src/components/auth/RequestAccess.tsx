    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background">
      ...
      <Card className="w-full max-w-md mx-4 sm:mx-auto shadow-2xl">
        <CardBody className="p-5 sm:p-8">
          ...
          <p className="text-default-500 mb-6">Submit a request to join this server</p>
          ...
          {success ? (
            <div className="space-y-4">
              <Alert color="success" variant="flat">{success}</Alert>
              <p className="text-default-500 text-sm">
                Your keys have been generated and stored. Once an admin approves your request,
                you can sign in using the login page.
              </p>
