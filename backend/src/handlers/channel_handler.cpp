...
template <bool SSL>
void ChannelHandler<SSL>::handle_create_channel(uWS::HttpResponse<SSL>* res, const std::string& body,
...
template <bool SSL>
void ChannelHandler<SSL>::handle_create_dm(uWS::HttpResponse<SSL>* res, const std::string& body,
                           const std::string& user_id) {
    try {
        auto j = json::parse(body);
